...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/flat-mountain-7088#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-mountain-7088
```

A live public deployment of this template is available at [https://flat-mountain-7088.templates.workers.dev](https://flat-mountain-7088.templates.workers.dev)
